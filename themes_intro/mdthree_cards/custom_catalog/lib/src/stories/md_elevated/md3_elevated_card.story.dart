...
const storyTitle = "MD3 Elevated Card";

// ignore: long-method
Scenario md3elevatedCard() {
  return Scenario(
    "MD3 Elevated Card",
    child: MD3ElevatedCard(
      ...
      cardColor: appBrightness== Brightness.dark ? appDarkColorScheme.surface : appLightColorScheme.surface,
      cardShadowColor: appBrightness==Brightness.dark ? appDarkColorScheme.shadow : appLightColorScheme.shadow,
      cardSurfaceTintColor: appBrightness==Brightness.dark ? appDarkColorScheme.surfaceTint : appLightColorScheme.surfaceTint,
      cardOnTap: () {},
      cardContent: Text(
