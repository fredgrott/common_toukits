...
final Color drawerHeaderTextColorLight = appLightColorScheme.onSurfaceVariant;
final Color drawerHeaderTextColorDark = appDarkColorScheme.onSurfaceVariant;

final Color drawerListTileIconColorLight = appLightColorScheme.onSurfaceVariant;
final Color drawerListTileIconColorDark = appDarkColorScheme.onSurfaceVariant;
final Color drawerListTileTextColorLight = appLightColorScheme.onSurfaceVariant;
final Color drawerListTileTextColorDark = appDarkColorScheme.onSurfaceVariant;

final Color drawerListTileSelectedIconTextColorLight =
    appLightColorScheme.secondaryContainer;
final Color drawerListTileSelectedIconTextColorDark =
    appDarkColorScheme.secondaryContainer;

final Color drawerListTileColorLight = appLightColorScheme.onSecondary;
final Color drawerListTileColorDark = appDarkColorScheme.onSecondary;

final Color drawerListTileSelectedColorLight = appLightColorScheme.secondaryContainer;
final Color drawerListTileSelectedColorDark = appDarkColorScheme.secondaryContainer;
...
final Color appMaterialDarkSplashColor =
    appDarkColorScheme.secondary.withOpacity(0.75);
