...
final Color appLightScrimColor =
    Color(lightCorePalette.neutralVariant.get(20)).withOpacity(0.4);

final Color appDarkScrimColor =
    Color(darkCorePalette.neutralVariant.get(20)).withOpacity(0.4);
