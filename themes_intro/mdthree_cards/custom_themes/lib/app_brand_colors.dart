...
final CorePalette brandTwoCorePalette = CorePalette.of(brandColorTwo.value);

final CorePalette brandThreeCorePalette = CorePalette.of(brandColorThree.value);

final CorePalette brandOneCorePalette = CorePalette.of(brandColorOne.value);

final Color brandOneLightPrimary = Color(brandOneCorePalette.primary.get(40));
final Color brandOneDarkPrimary = Color(brandOneCorePalette.primary.get(80));

final Color brandTwoLightPrimary = Color(brandTwoCorePalette.primary.get(40));
final Color brandTwoDarkPrimary = Color(brandTwoCorePalette.primary.get(80));

final Color brandThreeLightPrimary = Color(brandThreeCorePalette.primary.get(40));
final Color brandThreeDarkPrimary = Color(brandThreeCorePalette.primary.get(80));
