...
class MD3OutlinedCard extends StatefulWidget {
  ...
  @override 
  _MD3OutlinedCardState createState() => _MD3OutlinedCardState();
}

class _MD3OutlinedCardState extends State<MD3OutlinedCard> with MaterialStateMixin<MD3OutlinedCard> {
  @override
